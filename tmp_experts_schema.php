...
$sql = "SELECT COLUMN_NAME FROM USER_TAB_COLUMNS WHERE TABLE_NAME = 'EXPERTS' ORDER BY COLUMN_ID";
...
echo json_encode(['table' => 'EXPERTS', 'columns' => $cols], JSON_PRETTY_PRINT) . PHP_EOL;
