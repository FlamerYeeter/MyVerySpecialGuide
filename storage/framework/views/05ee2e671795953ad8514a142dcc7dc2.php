...
<body class="bg-white flex justify-center items-center min-h-screen p-4 sm:p-6 relative overflow-auto">
    ...
    <button
        ...
        onclick="window.location.href='<?php echo e(route('user.role')); ?>'">
...
<?php /**PATH C:\xampp\htdocs\MyVerySpecialGuide\MyVerySpecialGuide\resources\views/ds_register_1.blade.php ENDPATH**/ ?>