    ...
    <script>
     ...
     <script>
        document.getElementById('workplaceNext').addEventListener('click', function() {
            window.location.href = '<?php echo e(route("registerskills1")); ?>';
        });
    </script>
...
<?php /**PATH C:\xampp\htdocs\MyVerySpecialGuide\MyVerySpecialGuide\resources\views/ds_register_workplace.blade.php ENDPATH**/ ?>