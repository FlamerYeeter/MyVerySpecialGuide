...
<div class="flex min-h-screen">
  <!-- Sidebar -->
  <aside id="sidebar"
    class="fixed left-0 top-0 h-full w-64 bg-white shadow-lg flex flex-col justify-between border-r border-gray-200 transition-all duration-300 overflow-hidden z-30">
    <div>
      <!-- Header with Toggle -->
