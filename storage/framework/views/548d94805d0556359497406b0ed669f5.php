...
<body class="min-h-screen flex flex-col justify-center items-center bg-cover bg-center relative"
  ...
  <div class="bg-yellow-100 bg-opacity-90 rounded-2xl shadow-md p-8 sm:p-10 w-11/12 max-w-md text-center">
    ...
    <!-- Forgot Password -->
    <div class="mt-4">
      <a href="<?php echo e(route('forgotpassword')); ?>" class="text-sm text-gray-700 hover:underline font-medium">
...
</html><?php /**PATH C:\xampp\htdocs\MyVerySpecialGuide\resources\views/company-login.blade.php ENDPATH**/ ?>