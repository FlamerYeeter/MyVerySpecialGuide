  ...
  <header class="w-full bg-white border-b border-gray-200 shadow-sm px-6 sm:px-10 py-5">
    <div class="flex flex-wrap items-center justify-between gap-4 w-full">
      ...
      <div class="flex items-center gap-3 flex-shrink-0">
        <img src="<?php echo e(asset('image/logo.png')); ?>" alt="Logo" class="w-12 sm:w-14 h-12 sm:h-14 object-contain">
      ...
      <div id="navContainer"
        ...
        <nav id="navMenu" class="flex flex-wrap justify-center gap-3 sm:gap-4">
          <a href="<?php echo e(route('job.matches')); ?>"
...
<?php /**PATH C:\xampp\htdocs\MyVerySpecialGuide\resources\views/layouts/includes.blade.php ENDPATH**/ ?>