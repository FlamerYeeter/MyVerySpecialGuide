...
<body class="bg-white flex justify-center items-start min-h-screen p-4 sm:p-6 md:p-8 relative overflow-x-hidden">
    ...
    <button
        ...
        onclick="(history.length>1 ? history.back() : window.location.href='<?php echo e(route('registerskills1')); ?>')">
        ...
        (function() {
            ...
            next.addEventListener('click', function(e) {
                try {
                    ...
                    window.location.href = '<?php echo e(route('registerreview1')); ?>';
                } catch (e) {
...
<?php /**PATH C:\xampp\htdocs\MyVerySpecialGuide\MyVerySpecialGuide\resources\views/ds_register_job-preference-1.blade.php ENDPATH**/ ?>