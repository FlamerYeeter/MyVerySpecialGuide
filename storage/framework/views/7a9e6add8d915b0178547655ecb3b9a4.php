    ...
    <div class="font-sans bg-white text-gray-800">
        ...
        <section class="bg-[#10B981] py-10 text-center shadow-md rounded-b-3xl">
            <div class="flex flex-col items-center justify-center">
                <img src="<?php echo e(asset('image/targeticon.png')); ?>" alt="Goals Icon" class="w-24 h-24 mb-3 animate-bounce-slow">
  ...
  <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
    ...
    <div class="bg-white rounded-2xl shadow-lg p-6 text-center relative border-4 border-yellow-200 hover:scale-105 transition-transform duration-300">
      ...
      <div class="flex justify-center mb-3">
        <img src="<?php echo e(asset('image/progress.png')); ?>" alt="" class="h-12">
      </div>
    ...
    <div class="bg-white rounded-2xl shadow-lg p-6 text-center relative border-4 border-green-200 hover:scale-105 transition-transform duration-300">
      ...
      <div class="flex justify-center mb-3">
        <img src="<?php echo e(asset('image/completed.png')); ?>" alt="" class="h-12">
      </div>
    ...
    <div class="bg-white rounded-2xl shadow-lg p-6 text-center relative border-4 border-blue-200 hover:scale-105 transition-transform duration-300">
      ...
      <div class="flex justify-center mb-3">
        <img src="<?php echo e(asset('image/overall.png')); ?>" alt="" class="h-12">
      </div>
...
<?php echo $__env->make('layouts.includes', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\MyVerySpecialGuide\resources\views/career-goals-progress.blade.php ENDPATH**/ ?>