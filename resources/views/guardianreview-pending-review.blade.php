...
<!-- HEADER BANNER: NOTE AAYUSIN KO PA MAMAYA -->
  ...
  <div class="max-w-5xl mx-auto mt-10 px-4">
    <h3 class="text-lg font-bold text-yellow-600 mb-4">Pending Review: 1</h3>

    <!-- Job Card -->
    <div class="border-2 border-yellow-400 rounded-2xl p-6 bg-yellow-50/20 shadow-sm">
      ...
      <div class="bg-yellow-100 rounded-lg mt-6 p-4">
        <div class="flex items-center space-x-2 mb-2">
          ...
          <h5 class="font-semibold text-gray-800">Add your Feedback (Optional)</h5>
        </div>
        <textarea
