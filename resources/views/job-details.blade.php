...
@section('content')
    ...
    <a href="#main-content"
        class="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 bg-blue-600 text-white px-4 py-2 rounded-md z-50 focus:outline-none focus:ring-2 focus:ring-blue-300">Skip
        to main content</a>
        ...
        <main id="main-content" class="max-w-7xl mx-auto w-full px-6 sm:px-10 lg:px-12 py-8 sm:py-10">
                ...
                <div class="flex flex-col lg:flex-row justify-between gap-8 items-start lg:items-center">
                    ...
                    <div class="flex items-start gap-5 flex-1">
                        ...
                        <div class="flex-shrink-0">
                            <img id="job-logo-img" src="" alt="Company Logo"
                        ...
                        <div class="flex-1 min-w-0">
                            <h1 id="job-title"
                                class="text-3xl sm:text-4xl font-extrabold text-slate-900 mb-4 leading-tight">
                                Job Role
                            </h1>
                            ...
                            <div class="space-y-3">
                                ...
                                <div class="flex flex-wrap gap-4 text-lg text-slate-600">
                                    <div class="flex items-center gap-2">
                                        <img src="https://img.icons8.com/color/24/marker.png" alt="" aria-hidden="true"
                                            class="w-6 h-6" />
                                        <span id="job-location">Location</span>
                                    </div>

                                    <div class="flex items-center gap-2">
                                        <img src="https://img.icons8.com/color/24/time.png" alt="" aria-hidden="true"
                                            class="w-6 h-6" />
                                        <span id="job-post-date">Posted date</span>
                                    </div>

                                    <div class="px-3 py-1 bg-blue-100 text-blue-700 rounded-full font-semibold text-base"
                                        id="job-type">
                                        Work type
                                    </div>
                                </div>
                    ...
                    <div class="w-full lg:w-auto flex flex-col sm:flex-row gap-3">
                        ...
                        <button onclick="saveJob('{{ $job_id }}', this)" type="button" data-job-id="{{ $job_id }}"
                            class="save-btn inline-flex items-center justify-center gap-3 rounded-full border border-blue-700 bg-transparent px-8 py-4 text-lg font-bold text-blue-700 shadow-lg transition hover:bg-blue-700 hover:text-white hover:shadow-xl active:scale-95 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600"
                            aria-label="Save this job">
                            <img src="https://img.icons8.com/fluency/24/1E40AF/bookmark-ribbon.png" alt=""
                                aria-hidden="true" />
                            <span>Save job</span>
                        </button>
                    </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2 space-y-8">
                    ...
                    <section id="box-job-desc" class="bg-white border border-slate-200 rounded-3xl p-6 sm:p-8 shadow-sm">
                        ...
                        <div id="job-description-content"
                            class="text-slate-700 text-lg sm:text-xl leading-relaxed space-y-4 prose prose-headings:text-lg prose-headings:font-bold prose-a:text-blue-700 prose-a:underline">
                    ...
                    <section id="box-key-resp" class="bg-white border border-slate-200 rounded-3xl p-6 sm:p-8 shadow-sm">
                        ...
                        <div id="key-responsibilities-content"
                            class="text-slate-700 text-lg sm:text-xl leading-relaxed space-y-4 prose prose-headings:text-lg prose-headings:font-bold prose-li:text-base">
                    ...
                    <section id="box-working-env" class="bg-white border border-slate-200 rounded-3xl p-6 sm:p-8 shadow-sm">
                        ...
                        <div id="working-environment-content"
                            class="text-slate-700 text-lg sm:text-xl leading-relaxed space-y-4 prose prose-headings:text-lg prose-headings:font-bold">
                            <p class="text-gray-500 italic">No working environment details provided yet.</p>
                        </div>
                    </section>

                    <!-- Accessibility & Support Requirements  -->
                    <section id="box-accessibility"
                        class="bg-white border border-slate-200 rounded-3xl p-6 sm:p-8 shadow-sm">
                        <div class="flex justify-between items-start mb-5">
                        ...
                        <div
                            ...
                            <p class="text-sm text-gray-600 mb-4">
                                This section helps you understand the workplace conditions, communication methods, and
                                available support
                ...
                <div class="space-y-8">
                        ...
                        <div class="space-y-5">
                            ...
                            <div>
                                ...
                                <div class="w-full bg-slate-200 h-3 rounded-full">
                                    <div id="capacity-bar" class="bg-blue-600 h-3 rounded-full w-0 transition-all"
                                        role="progressbar" aria-valuemin="0" aria-valuemax="100" aria-valuenow="0"
                                        aria-label="Applications received progress"></div>
                                </div>
                    ...
                    <!-- HIRING MANAGER -->
                    <section id="box-hiring-manager"
                        class="bg-white border border-slate-200 rounded-3xl p-6 sm:p-7 shadow-sm">
                        <div class="flex justify-between items-start mb-5">
                        ...
                        <div id="managers-list-container">
                            <ul id="managers-list" class="list-none p-0 m-0">
                                <li class="flex items-center gap-3 py-2">
                                    <div
                                        class="w-10 h-10 rounded-full bg-gray-100 border border-gray-300 flex items-center justify-center overflow-hidden">
                                        <i class="ri-user-line text-gray-400 text-xl"></i>
                                    </div>
                                    <span id="manager-name" class="font-medium text-base text-gray-800">No manager
                                        assigned</span>
                                </li>
                            </ul>
                        </div>
                    ...
                    <section id="box-contact" class="bg-white border border-slate-200 rounded-3xl p-6 sm:p-7 shadow-sm">
                        ...
                        <div class="space-y-4 text-slate-700">
                            ...
                            <div class="flex gap-3 items-start">
                                <img src="https://img.icons8.com/color/24/phone.png" alt="" aria-hidden="true"
                                    class="w-6 h-6 flex-shrink-0 mt-1" />
                                <a id="contact-phone" href="tel:"
                                    class="text-lg hover:text-blue-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-blue-600">Not
                                    available</a>
                            </div>

                            <div class="flex gap-3 items-start">
                                <img src="https://img.icons8.com/color/24/new-post.png" alt="" aria-hidden="true"
                                    class="w-6 h-6 flex-shrink-0 mt-1" />
                                <a id="contact-email" href="mailto:"
                                    class="text-lg hover:text-blue-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-blue-600">No
                                    email</a>
                            </div>

                            {{-- <div class="flex gap-3 items-start">
                                <img src="https://img.icons8.com/color/24/building.png" alt="" aria-hidden="true"
                                    class="w-6 h-6 flex-shrink-0 mt-1" />
                                <span id="contact-industry" class="text-lg">Not specified</span>
                            </div> --}}

                            <div class="flex gap-3 items-start">
                                <img src="https://img.icons8.com/color/24/link.png" alt="" aria-hidden="true"
                                    class="w-6 h-6 flex-shrink-0 mt-1" />
                                <a id="company-website" href="#" target="_blank"
                                    class="text-lg text-blue-700 hover:text-blue-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-blue-600">
                                    <span id="company-website-text">No website available</span>
                                </a>
                            </div>

                            {{-- <div class="flex gap-3 items-start">
                                <img src="https://img.icons8.com/color/24/map.png" alt="" aria-hidden="true"
                                    class="w-6 h-6 flex-shrink-0 mt-1" />
                                <a id="company-map" href="#" target="_blank"
                                    class="text-lg text-blue-700 hover:text-blue-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-blue-600">
