        ...
        <form class="mt-10 max-w-3xl mx-auto">
            ...
            <div class="grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6 mt-8 px-2 sm:px-4">
                ...
                <div class="bg-white p-4 sm:p-5 rounded-2xl transition-all duration-300 hover:bg-blue-100 hover:shadow-xl hover:-translate-y-1 cursor-pointer relative text-center skills-card"
                    data-value="Attention to details" onclick="toggleSkills2Choice(this,'Attention to details')">
                    <button
                ...
                <!-- Other -->
                <div class="bg-white p-4 sm:p-5 rounded-2xl transition-all duration-300 hover:bg-blue-100 hover:shadow-xl hover:-translate-y-1 cursor-pointer relative text-center skills-card"
                    data-value="other" onclick="toggleSkills2Choice(this,'other')">
                    <button
                        class="absolute top-3 right-3 bg-blue-500 hover:bg-blue-600 text-white p-2 rounded-full shadow transition">🔊</button>
            ...
            <div class="w-full flex flex-col items-center justify-center mt-12 mb-8">
                ...
                <p class="text-gray-600 text-sm mt-2 text-center">
                    Click <span class="text-blue-500 font-medium">"Next"</span> to move to the next page Job
                    Preferences<br>
            ...
            <script>
                ...
                function toggleSkills2Choice(el, value) {
                    try {
                        ...
                        console.error('toggleSkills2Choice error', e);
                    }
                }
            </script>
    </div>
