        ...
        <script>
            (function(){
                ...
                function makeCard(job) {
                    ...
                    posted.textContent = job.apply_before ? ('Apply by ' + formatNiceDateOrOriginal(job.apply_before)) : (job.posted_date ? formatNiceDateOrOriginal(job.posted_date) : 'Posted date');
