...
<head>
    ...
    <title>AdminHub - Approval Workflow</title>
...
<body class="bg-gray-50 min-h-screen flex">
    ...
    <main class="flex-1 p-4">
        ...
        <div class="w-full bg-gray-50 rounded-lg mb-10 -mx-4 sm:-mx-6 px-6">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-3 flex items-center gap-3 relative">
                                <!-- Eye Icon -->
                                <button class="text-gray-600 hover:text-blue-500 toggle-guardian">
                        ...
                        <!-- Guardian Info Row (hidden by default) -->
                        <tr class="guardian-info hidden bg-gray-50">
                            <td colspan="9" class="px-6 py-4">
                                <!-- Guardian Header -->
                                <div class="mb-2">
                                    <h4 class="text-black-700 font-semibold text-sm">Guardian Information</h4>
                                </div>
                                <!-- Guardian Details -->
                                <div class="grid grid-cols-2 gap-4">
                                    <div><strong class="text-[#F895BE]">First Name:</strong> —</div>
                                    <div><strong class="text-[#F895BE]">Last Name:</strong> —</div>
                                    <div><strong class="text-[#F895BE]">Email Address:</strong> —</div>
                                    <div><strong class="text-[#F895BE]">Contact Number:</strong> —</div>
                                    <div><strong class="text-[#F895BE]">Relationship to User:</strong> —</div>
                                    <div>
                                        <strong class="text-[#F895BE]">Proof of Membership:</strong>
            ...
            <!-- Approval table Scripts -->
            <script>
                // Toggle Guardian Info Row
                document.querySelectorAll('.toggle-guardian').forEach(button => {
                    button.addEventListener('click', () => {
                        const currentRow = button.closest('tr');
                        const nextRow = currentRow.nextElementSibling;
                        if (nextRow && nextRow.classList.contains('guardian-info')) {
          ...
          : "text-blue-500 hover:bg-gray-100"}`;
            ...
            <div class="bg-white shadow-md rounded-lg overflow-hidden">
                <table class="min-w-full text-sm">
                    <thead class="bg-[#F895BE] text-white">
                        <tr>
