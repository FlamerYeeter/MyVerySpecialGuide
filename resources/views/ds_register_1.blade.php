...
<div class="text-center mt-8">
  ...
  <div class="mt-6 flex flex-col items-start text-left max-w-xl mx-auto">
    ...
    <p class="mt-2 text-gray-600 italic border-b-2 border-blue-500 pb-1 w-full">
...
<div class="mt-6 max-w-xl mx-auto">
  <div class="mt-2 flex items-start gap-1">
    ...
    <div>
      <p class="mt-2 text-black-100 text-sm leading-relaxed">
    ...
    <button class="mt-2 text-xl leading-none hover:scale-110 transition-transform">🔊</button>
  </div>
</div>
...
<div class="mt-12 max-w-xl mx-auto">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h3 class="text-lg text-blue-500 font-semibold flex items-center gap-2 flex-wrap">
      ...
      <span class="text-gray-600 italic text-sm">(Pagkakasunod-sunod ng pag gawa ng account)</span>
      <button class="text-xl leading-none hover:scale-110 transition-transform">🔊</button>
       ...
       <div class="space-y-4">
        <div class="bg-white rounded-xl p-5 border border-blue-300 flex gap-4 items-start shadow-sm hover:shadow-md transition-shadow">
          <img src="image/1icon.png" alt="Step 1 Icon" class="w-8 h-8 mt-1">
          <div class="flex-1">
            ...
            <p class="mt-2 text-gray-600 italic text-sm leading-snug">
        ...
        <!-- Step 2 -->
        <div class="bg-white rounded-xl p-5 border border-blue-300 flex gap-4 items-start shadow-sm hover:shadow-md transition-shadow">
           <img src="image/2icon.png" alt="Step 2 Icon" class="w-8 h-8 mt-1">
          <div class="flex-1">
            ...
            <p class="mt-2 text-gray-600 italic text-sm leading-snug">(Ibahagi ang iyong personal na impormasyon at impormasyon ng magulang/tagapag-alaga)</p>
          </div>
          <button class="text-xl leading-none hover:scale-110 transition-transform">🔊</button>
        </div>
        ...
        <!-- Step 3 -->
        <div class="bg-white rounded-xl p-5 border border-blue-300 flex gap-4 items-start shadow-sm hover:shadow-md transition-shadow">
           <img src="image/3icon.png" alt="Step 3 Icon" class="w-8 h-8 mt-1">
          <div class="flex-1">
            <p class="font-semibold text-gray-800 leading-relaxed">Tell us about your educational background and work experience</p>
            <p class="mt-2 text-gray-600 italic text-sm leading-snug">(Ibahagi ang iyong pinag-aralan at karanasan sa trabaho)</p>
          </div>
          <button class="text-xl leading-none hover:scale-110 transition-transform">🔊</button>
        </div>
        ...
        <!-- Step 4 -->
        <div class="bg-white rounded-xl p-5 border border-blue-300 flex gap-4 items-start shadow-sm hover:shadow-md transition-shadow">
           <img src="image/4icon.png" alt="Step 4 Icon" class="w-8 h-8 mt-1">
          <div class="flex-1">
            <p class="font-semibold text-gray-800 leading-relaxed">Choose the support you need and preferred work environment</p>
            <p class="mt-2 text-gray-600 italic text-sm leading-snug">(Piliin ang suportang kailangan mo at ang uri ng lugar ng trabaho na gusto mo)</p>
          </div>
          <button class="text-xl leading-none hover:scale-110 transition-transform">🔊</button>
        </div>
        ...
        <!-- Step 5 -->
        <div class="bg-white rounded-xl p-5 border border-blue-300 flex gap-4 items-start shadow-sm hover:shadow-md transition-shadow">
           <img src="image/5icon.png" alt="Step 5 Icon" class="w-8 h-8 mt-1">
          <div class="flex-1">
            <p class="font-semibold text-gray-800 leading-relaxed">Choose the skills you have</p>
            <p class="mt-2 text-gray-600 italic text-sm leading-snug">(Pumili ng mga kakayahan na meron ka)</p>
          </div>
          <button class="text-xl leading-none hover:scale-110 transition-transform">🔊</button>
        </div>
        ...
        <!-- Step 6 -->
        <div class="bg-white rounded-xl p-5 border border-blue-300 flex gap-4 items-start shadow-sm hover:shadow-md transition-shadow">
           <img src="image/6icon.png" alt="Step 6 Icon" class="w-8 h-8 mt-1">
          <div class="flex-1">
            <p class="font-semibold text-gray-800 leading-relaxed">Select the types of jobs you like</p>
            <p class="mt-2 text-gray-600 italic text-sm leading-snug">(Piliin ang mga uri ng trabaho na gusto mo)</p>
          </div>
          <button class="text-xl leading-none hover:scale-110 transition-transform">🔊</button>
        </div>
        ...
        <!-- Step 7 -->
        <div class="bg-white rounded-xl p-5 border border-blue-300 flex gap-4 items-start shadow-sm hover:shadow-md transition-shadow">
           <img src="image/7icon.png" alt="Step 7 Icon" class="w-8 h-8 mt-1">
          <div class="flex-1">
            <p class="font-semibold text-gray-800 leading-relaxed">Review the information you entered and finish</p>
            <p class="mt-2 text-gray-600 italic text-sm leading-snug">(I-review ang impormasyong iyong inilagay at tapusin)</p>
          </div>
          <button class="text-xl leading-none hover:scale-110 transition-transform">🔊</button>
        </div>
      </div>
    ...
    <!-- Next Button -->
    <div class="flex flex-col items-center justify-center mt-4 min-h-[200px]">
