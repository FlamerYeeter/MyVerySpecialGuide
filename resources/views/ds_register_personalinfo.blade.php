  ...
  <div>
    ...
    <p class="mt-2 text-gray-800 font-semibold">Halimbawa: Lovedog12</p>
      ...
      <div class="text-center mt-12">
        <button class="bg-blue-500 text-white font-semibold text-lg px-24 py-3 rounded-xl hover:bg-blue-600 transition flex items-center gap-2 justify-center mx-auto shadow-md">
          Next →
        </button>
