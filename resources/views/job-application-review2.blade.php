  ...
  <section class="max-w-5xl mx-auto mt-8 px-4 mb-16">
    ...
    <div class="bg-white border rounded-lg p-6 mb-8 shadow-sm">
      <div class="flex justify-between items-center mb-4">
        ...
        <a href="/job-application-education" class="text-gray-600 bg-gray-100 px-3 py-1 rounded text-sm hover:bg-gray-200">Edit</a>
      </div>
      <div class="space-y-2 text-sm text-gray-700">
        <p><span class="font-medium text-gray-800">Highest Education:</span> High School</p>
        <p><span class="font-medium text-gray-800">School:</span> Taguig National High School</p>
        <p><span class="font-medium text-gray-800">Year Graduated:</span> 2016</p>
      </div>
    </div>
    ...
    <div class="bg-white border rounded-lg p-6 mb-8 shadow-sm">
      <div class="flex justify-between items-center mb-4">
        ...
        <a href="/job-application-skills" class="text-gray-600 bg-gray-100 px-3 py-1 rounded text-sm hover:bg-gray-200">Edit</a>
      </div>
      ...
      <div class="text-sm text-gray-700 space-y-3">
        <div>
          ...
          <div class="flex flex-wrap gap-2">
            ...
            <span class="bg-blue-100 text-blue-700 px-3 py-1 rounded-full text-xs font-medium">Animal Care</span>
            <span class="bg-blue-100 text-blue-700 px-3 py-1 rounded-full text-xs font-medium">Customer Service</span>
          </div>
        </div>
        ...
        <div>
          ...
          <ul class="list-disc list-inside text-gray-700 space-y-1">
            <li>Basic First Aid (Red Cross, 2023)</li>
            <li>Customer Service Fundamentals (Coursera, 2024)</li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <!-- Uploaded Documents -->
<!-- This is the example of uploaded documents.
    <div class="bg-white border rounded-lg p-6 shadow-sm">
      <div class="flex justify-between items-center mb-4">
        <h3 class="text-lg font-semibold text-gray-800">Uploaded Documents</h3>
        <a href="/job-application-documents" class="text-gray-600 bg-gray-100 px-3 py-1 rounded text-sm hover:bg-gray-200">Edit</a>
      </div>
      <div class="bg-green-100 border border-green-300 rounded-lg p-4">
        <p class="text-sm font-medium text-gray-800">Juan_DelaCruz_Resume.pdf</p>
        <p class="text-xs text-gray-600">2.3 MB</p>
      </div>
    </div>
-->
    <div class="bg-white border rounded-lg p-6 shadow-sm">
        <div class="flex justify-between items-center mb-4">
            <h3 class="text-lg font-semibold text-gray-800">Uploaded Documents</h3>
            <a href="/job-application-2" class="text-gray-600 bg-gray-100 px-3 py-1 rounded text-sm hover:bg-gray-200">Edit</a>
        </div>
        <div class="bg-green-100 border border-green-300 rounded-lg p-4">
