...
@section('content')
    <div class="font-sans bg-white text-gray-700">
        ...
        <div class="text-center">
            <h2 class="mt-8 text-2xl sm:text-3xl md:text-5xl font-bold mb-4 drop-shadow-lg text-blue-700">
                Just like you
            </h2>
        </div>
        ...
        <section
            ...
            <!-- Content Grid -->
            <div
                class="relative z-10 max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center px-4 sm:px-8 md:px-16">

                <!-- Text -->
                <div>
                    <p class="text-sm sm:text-base md:text-lg leading-relaxed text-gray-700 text-justify">
                        ...
                        that true inclusion is about fairness and respect.
                    </p>
                </div>

                <!-- Image -->
                <div class="flex justify-center md:justify-end">
                    <img src="/image/img6.png" alt="animated indiv with ds"
