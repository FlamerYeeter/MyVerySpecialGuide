...
<head>
    ...
    <title>AdminHub - Moderation</title>
        ...
        <div
            ...
            <div>
                <div class="text-sm text-gray-500">
                    ...
                    <span class="text-gray-700 font-medium">Moderation</span>
                </div>
            </div>
...
<div class="flex flex-col space-y-4">
  <!-- Flagged Queue Card -->
  <div class="bg-white rounded-xl shadow p-4 relative w-48">
    <div class="text-gray-600 text-sm font-medium">Flagged Queue</div>
    <div class="text-3xl font-bold mt-2">20</div>
    <div class="absolute top-0 right-0 h-full w-1 bg-yellow-400 rounded-r-xl"></div>
  </div>
  ...
  <div>
    ...
    <select
      class="block mt-1 border border-gray-300 rounded-md px-3 py-2 bg-white text-gray-700 focus:outline-none focus:ring-2 focus:ring-emerald-500">
      <option>All</option>
      ...
      <option>Removed</option>
            ...
            <table class="min-w-full text-left">
                ...
                <tr>
                    <th class="px-6 py-3 font-semibold text-sm">Job Name</th>
                    <th class="px-6 py-3 font-semibold text-sm">Details</th>
                    <th class="px-6 py-3 font-semibold text-sm">Reason</th>
                    <th class="px-6 py-3 font-semibold text-sm">Time & Date</th>
                    <th class="px-6 py-3 font-semibold text-sm">Status</th>
                    <th class="px-6 py-3 font-semibold text-sm text-center align-middle w-24">Action</th>
                </tr>
                </thead>
                ...
                <?php for ($i = 0; $i < 1; $i++): ?>
                <tr class="bg-gray-50">
                    <td class="px-6 py-3 text-gray-700 align-middle">-</td>
                    <td class="px-6 py-3 text-gray-700 align-middle">-</td>
                    <td class="px-6 py-3 text-gray-700 align-middle">-</td>
                    <td class="px-6 py-3 text-gray-700 align-middle">-</td>
                    <td class="px-6 py-3 text-yellow-600 align-middle">-</td>
                    <td class="px-6 py-3 text-center align-middle relative w-24">
                    <div class="flex justify-center items-center">
                            
              <!-- 3 Dots Button -->
  <div class="relative">
    <button onclick="openModal()" 
      class="p-1 rounded-full hover:bg-gray-100 transition inline-flex items-center justify-center">
      <svg
  ...
  <div id="confirmModal" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
    <div class="bg-white rounded-md shadow-lg p-6 w-80 text-center">
      <p class="text-gray-700 mb-6 text-sm font-medium">
        Are you sure you want to remove this content?
      </p>
      <div class="flex justify-center gap-4">
        <button 
          onclick="confirmAction()" 
          class="bg-blue-600 text-white text-sm font-medium px-4 py-2 rounded hover:bg-blue-700 focus:ring-2 focus:ring-blue-300 transition">
          Confirm
        </button>
        <button 
          onclick="closeModal()" 
          class="border border-gray-300 text-sm font-medium px-4 py-2 rounded hover:bg-gray-100 transition">
          Cancel
        </button>
      </div>
    </div>
