...
<head>
    ...
    <title>AdminHub - Job Posting Approval </title>
        ...
        <div class="w-full bg-gray-50 rounded-lg mb-10 -mx-4 sm:-mx-6 px-6">
                ...
                <table class="min-w-full border-collapse text-sm">
                    <thead>
                        <tr class="bg-[#F5AB3C] text-white">
                            ...
                            <th class="px-4 py-3 text-left">Job Post</th>
                    ...
                    <tbody class="divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <!-- Job Post (Review Button) -->
                            <td class="px-4 py-3">
                                <button
                                    class="bg-[#057773] text-white font-medium text-xs px-4 py-1.5 rounded-full hover:bg-green-600 transition">
                                    Review
                                </button>
                            </td>
            ...
            <div class="flex justify-center items-center space-x-2 mt-6" id="pagination">
                <button id="prevPage"
                    ...
                    <i class="ri-arrow-left-s-line"></i><span>Previous</span>
                </button>
            ...
            <script>
                ...
                document.addEventListener("DOMContentLoaded", () => {
                    const rows = Array.from(document.querySelectorAll("tbody tr"))
                        .filter(row => !row.classList.contains("account-info"));
                ...
                <table class="min-w-full border-collapse text-sm">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-3">
                                <button
                                    class="bg-[#057773] text-white text-xs px-4 py-1.5 rounded-full hover:bg-green-600 transition">
                                    Review
                                </button>
                            </td>
                        </tr>
