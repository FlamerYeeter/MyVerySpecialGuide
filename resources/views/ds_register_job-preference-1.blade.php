  ...
  <div class="bg-yellow-100 max-w-3xl w-full rounded-2xl shadow-lg p-8 relative z-10">
    ...
    <div class="flex flex-col items-start text-left max-w-xl mx-auto">
      <h2 class="text-xl font-semibold text-blue-500 border-b-2 border-blue-500 w-full mb-2 flex items-center gap-2">
        Job Preferences 
        <span class="text-gray-600 italic text-base">(Trabahong Iyong Gusto)</span>
        <button type="button" class="text-gray-500 text-xl leading-none hover:scale-110 transition-transform">🔊</button>
      </h2>

      <!-- Description -->
      <div class="flex items-center gap-2 mt-4">
        <p class="text-base font-medium">Based on your skills, here are jobs that match you:</p>
        <button type="button" class="text-gray-500 text-xl leading-none hover:scale-110 transition-transform">🔊</button>
      </div>
      ...
      <p class="mt-2 text-blue-500 font-semibold underline">
      ...
      <div class="flex items-start gap-2 mt-10">
        <div>
          <p class="text-base font-medium leading-snug">
            Choose your job preferences from the pictures provided and click your answers.
            You can select up to 3–5 options only.
          </p>
        ...
        <button type="button" class="text-gray-500 text-xl hover:scale-110 transition-transform">🔊</button>
      </div>
