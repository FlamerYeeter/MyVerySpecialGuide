  ...
  <div class="bg-yellow-100 max-w-3xl w-full rounded-2xl shadow-lg p-8 relative z-10">
    ...
    <form class="mt-8 max-w-xl mx-auto">
      ...
      <div class="text-center mt-12">
        <button type="submit" class="bg-blue-500 text-white font-semibold text-lg px-24 py-3 rounded-xl hover:bg-blue-600 transition flex items-center gap-2 justify-center mx-auto shadow-md">
          Next →
        </button>
