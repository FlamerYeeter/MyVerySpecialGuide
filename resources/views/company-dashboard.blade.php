...
<script>
  ...
  document.addEventListener('click', (e) => {
   ...
   <!-- Job Statistic Card -->
  <div class="bg-white rounded-2xl shadow-md w-[550px] p-6">
    ...
    <div class="flex flex-col lg:flex-row items-start gap-8">
      ...
      <div class="space-y-4 min-w-[180px]">
        ...
        <div class="border rounded-lg p-4 text-sm text-gray-700 shadow-sm">
          ...
          <div class="text-2xl font-semibold text-gray-900">100</div>
          <p class="text-xs text-gray-400">This week</p>
        </div>
      </div>
    </div>
 ...
 <section class="bg-white shadow rounded-2xl p-6 w-[280px] h-fit ml-auto lg:ml-[80px]">
