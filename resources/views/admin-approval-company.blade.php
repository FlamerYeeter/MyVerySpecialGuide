...
<head>
    ...
    <title>AdminHub - Company Account Approval </title>
        ...
        <div class="w-full bg-gray-50 rounded-lg mb-10 -mx-4 sm:-mx-6 px-6">
            ...
            <div class="bg-gray-100 rounded-lg p-2 mb-6 w-full px-6">
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <button
                        class="text-gray-500 hover:text-gray-700 font-medium text-sm px-6 py-2 transition w-full">
                        EXPERT
                    </button>
                    <button class="bg-white text-gray-900 font-semibold text-sm shadow-sm rounded-md px-6 py-2 border border-gray-200 w-full">
                        COMPANY
                    </button>
                    <button class="text-gray-500 hover:text-gray-700 font-medium text-sm px-6 py-2 transition w-full">
                        JOB POSTING
            ...
            <div class="bg-white shadow-md rounded-lg mb-10 overflow-x-auto">
                <table class="min-w-full border-collapse text-sm">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        ...
                        <!-- Account & Company Info Row (hidden by default) -->
                            ...
                            <td colspan="9" class="px-6 py-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class=" mt-4 grid grid-cols-2 gap-4">
                                        <div><strong class="text-[#67A467]">Username:</strong> —</div>
                                        <div>
                                            <strong class="text-[#67A467]">Valid ID Upload:</strong>
                                ...
                                <!-- Company Information -->
                                <div>
                                    <h4 class="mt-2 text-black-700 font-semibold text-sm">Company Information</h4>
                                    <div class="mt-4 grid grid-cols-2 gap-4">
                                        <div><strong class="text-[#67A467]">Company Name:</strong> —</div>
                                        <div><strong class="text-[#67A467]">Business Permit:</strong>
                                            <a href="#" class="text-blue-500 underline">View File</a>
                                        </div>
                                        <div><strong class="text-[#67A467]">Authorized Person Position:</strong> —
                                        </div>
                                        <div><strong class="text-[#67A467]">Area of Specialization:</strong> —</div>
                                        <div><strong class="text-[#67A467]">Work Address:</strong> —</div>
                                        <div>
                                            <strong class="text-[#67A467]">Proof of Employment:</strong>
                                            <a href="#" class="text-blue-500 underline">View File</a>
                                        </div>
                                    </div>
                                </div>
