      ...
      <table class="w-full text-sm text-left border-collapse">
        ...
        <tbody>
          <tr class="border-b">
            ...
            <td class="px-4 py-3">48 Block Magiting St. West Rembo, Taguig City</td>
            ...
            <td colspan="9" class="p-5">
              <div class="grid grid-cols-2 gap-8 text-sm">
                <div>
                  ...
                  <table class="w-full border-collapse text-gray-700">
                    ...
                    <tr>
                      ...
                      <td>
                        <span class="bg-gray-100 border px-2 py-1 text-xs rounded inline-flex items-center mt-1">
                          📄 Juan_DelaCruz_ID.pdf
                        </span>
                      </td>
                    </tr>
                  </table>
                ...
                <div>
                  ...
                  <table class="w-full border-collapse text-gray-700">
                    <tr>
                      <td class="font-medium w-1/3">Company Name</td>
                      <td>ABC Builders Inc.</td>
                    </tr>
                    <tr>
                      <td class="font-medium">Business Permit</td>
                      <td>
                        <span class="bg-gray-100 border px-2 py-1 text-xs rounded inline-flex items-center">
                          📄 Juan_BusinessPermit.pdf
                        </span>
                      </td>
                    </tr>
                    <tr>
