...
<body class="bg-white flex justify-center items-center min-h-screen p-4 relative overflow-auto">
  ...
  <div class="bg-yellow-100 max-w-3xl w-full rounded-2xl shadow-lg p-8 relative z-10">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8 max-w-xl mx-auto">
      ...
      <!-- Card 1 -->
      <div
        class="bg-white p-4 rounded-xl shadow h-[340px] transition-all duration-300 hover:bg-blue-100 hover:shadow-xl hover:-translate-y-1 cursor-pointer relative">
        <button
    ...
    <form class="mt-12 max-w-xl mx-auto">
      ...
      <div class="mt-6 text-left">
        <label class="font-semibold text-sm flex items-center gap-1">
          If you have work experience, type your previous job title and description 
        ...
        <p class="text-gray-500 italic text-[13px]">
          Kung may trabaho ka dati, i-type ang iyong posisyon sa trabaho at gawain
        </p>
        <input type="text" placeholder="Job Description"
               class="mt-1 w-full border border-gray-300 rounded-md px-3 py-2 focus:ring focus:ring-blue-200" />
        <p class="text-gray-500 text-xs mt-2">
          Type your previous job description (example: 
          <span class="font-semibold">Kitchen Helper: Cleaned tables, Organized shelves</span>).
        </p>
      </div>
      ...
      <div class="mt-8 text-left">
        <label class="font-semibold text-sm flex items-center gap-1">
          Where did you work? (Company Name)
          <button type="button" class="text-gray-500 text-xl leading-none hover:scale-110 transition-transform">🔊</button>
        </label>
        <p class="text-gray-500 italic text-[13px]">Anong kompanya ka nagtrabaho?</p>
        <input type="text" placeholder="Company Name"
               class="mt-1 w-full border border-gray-300 rounded-md px-3 py-2 focus:ring focus:ring-blue-200" />
        <p class="text-gray-500 text-xs mt-2">
          Type the name of the company you worked (example:
          <span class="font-semibold">Mcdonald's</span>).
        </p>
      </div>

      <!-- Add Another Job Experience Section -->
      <div class="text-center mt-8 bg-yellow-50 py-6 rounded-lg">
        <p class="text-gray-700">
          Do you have more job experience? You can add another one:
        </p>
        <p class="text-gray-500 italic text-[12px] mb-3">
          May iba ka pa bang karanasan sa trabaho? Maaari kang magdagdag ng isa pa:
        </p>
        <button
          class="flex items-center justify-center mx-auto bg-blue-500 text-white font-medium px-6 py-2 rounded-md hover:bg-blue-600 transition">
